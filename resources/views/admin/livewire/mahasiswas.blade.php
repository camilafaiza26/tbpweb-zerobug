@extends('admin.navigation-menu')
                 ...
                 <div class="mt-8 bg-white dark:bg-gray-800 overflow-hidden shadow sm:rounded-lg px-6 py-6">
                     ...
                     <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                         <button  wire:click="showModal()"  class="bg-indigo-700 text-white font-bold py-3 px-4 rounded mb-2 inline-flex items-center  transition duration-500 ease-in-out bg-indigo-600 hover:bg-indigo-900 transform hover:-translate-y-1 hover:scale-110 ">
                             ...
                             @if($isOpen)
                                 @include('admin.livewire.createm');
                                 @endif          
                     ...
                     <table class="table-auto w-full">
                         <thead style="background-color:#4723D9">
                             <tr class="h-14">
                                 ...
                                 {{-- <th class="px-4 py-2 text-white w-auto">Password</th> --}}
                         ...
                         <tbody>
                             ...
                             <tr class="h-12 hover:bg-gray-100">          
                                 ...
                                 <td class="text-center">
                                     <button wire:click="edit({{ $mahasiswa->id }})" class="bg-blue-500 text-white font-bold py-1 px-4 rounded  transition duration-500 ease-in-out bg-blue-600 hover:bg-blue-500 transform hover:-translate-y-1 hover:scale-110 ">
                                     Edit
                                     </button>
                                     <button wire:click="deleteConfirms({{ $mahasiswa->id }})" class="bg-red-500 hover:bg-red-700 text-white font-bold py-1 px-4 rounded  transition duration-500 ease-in-out bg-red-600 hover:bg-red-500 transform hover:-translate-y-1 hover:scale-110 ">
                                     Hapus
                                     </button>
                                 </td>
                             </tr>
 ...
 <x-jet-dialog-modal wire:model="deleteConfirms">
    ...
    <x-slot name="content">
        {{ __('Apakah anda yakin menghapus mahasiswa ini?') }}
    </x-slot>
